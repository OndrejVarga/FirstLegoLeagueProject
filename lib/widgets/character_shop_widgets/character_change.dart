        ...
        child: Column(
          ...
          children: [
            CharacterOption(Provider.of<ImageController>(context).skinsNames,
                'skin', Provider.of<ImageController>(context).skins, 'Tvár'),
            CharacterOption(
            ...
            CharacterOption(Provider.of<ImageController>(context).eyesNames,
                'eyes', Provider.of<ImageController>(context).eyes, 'Oči'),
            CharacterOption(
            ...
            CharacterOption(Provider.of<ImageController>(context).hairNames,
                'hair', Provider.of<ImageController>(context).hair, 'Vlasy'),
            CharacterOption(Provider.of<ImageController>(context).lipsNames,
                'lips', Provider.of<ImageController>(context).lips, 'Ústa'),
          ],
        ),
      ),
    );
